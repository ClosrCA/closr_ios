...
open class DefaultAPI: APIBase {
    /**
     ...
     - parameter eventCreate: (body) Event boday 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func create(authorization: String, eventCreate: EventCreate, completion: @escaping ((_ error: Error?) -> Void)) {
        createWithRequestBuilder(authorization: authorization, eventCreate: eventCreate).execute { (response, error) -> Void in
            completion(error);
        }
    }
     ...
     */
    open class func createWithRequestBuilder(authorization: String, eventCreate: EventCreate) -> RequestBuilder<Void> {
