...
//                return "Purpose:"
    ...
    fileprivate lazy var chatBarButtonItem: UIBarButtonItem = {
        let barButtonItem = UIBarButtonItem(image: UIImage(named: "icon_chat"), style: .plain, target: self, action: #selector(selectChat))
